...
C:\"Program Files (x86)"\"Windows Kits"\10\bin\10.0.26100.0\x64\signtool sign /f c:\dev\flightpath\packaging\assets\FlightPathCert.pfx /p hangzhou /fd SHA256 C:\dev\flightpath_packaging\universal\x64\FlightPathData-x64-test.msix
